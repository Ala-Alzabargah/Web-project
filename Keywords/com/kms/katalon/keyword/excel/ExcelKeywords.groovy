...
class ExcelKeywords {
	...
	static void setValueToCell(Cell cell, def value) {
		if (cell == null || value == null) {
			println "setValueToCell as 'if (cell == null || value == null)'"
			return
		}
		...
		switch(type) {
			case "String":
				...
				println "setValueToCell as String"
				break
			case "Boolean":
				cell.setCellType(Cell.CELL_TYPE_BOOLEAN)
				cell.setCellValue((Boolean) value)
				println "setValueToCell as Boolean"
				break
			case "Integer":
			case "Long":
			case "Float":
			...
			case "BigDecimal":
				...
				println "setValueToCell as BigDecimal"
				break
			case "Date":
				cell.setCellType(Cell.CELL_TYPE_NUMERIC)
				...
				println "setValueToCell as Date"
				break
			default:
				cell.setCellType(Cell.CELL_TYPE_STRING)
				cell.setCellValue(value.toString())
				println "setValueToCell as default"
				break
		}
	}
